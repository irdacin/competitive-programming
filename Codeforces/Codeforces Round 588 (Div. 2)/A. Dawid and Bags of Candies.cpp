...
void solve(){
  ...
  auto func = [&](auto func, int i, int tot1, int tot2){  
    if(i == 4) return tot1 == tot2;

    bool ret = false;
    ret |= func(func, i + 1, tot1 + a[i], tot2);
    ret |= func(func, i + 1, tot1, tot2 + a[i]);
    return ret;
  };

  print(func(func, 0, 0, 0) ? "YES" : "NO");
}
