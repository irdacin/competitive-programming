...
template <typename T> inline bool chmin(T &A, const T &B) { if (A > B) return A = B, true; return false; }
template <typename T> inline bool chmax(T &A, const T &B) { if (A < B) return A = B, true; return false; }
