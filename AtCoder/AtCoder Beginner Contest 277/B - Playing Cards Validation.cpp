...
void solve(){
  ...
  for(string s; n--;){
    cin >> s;
    if(s.front() != 'H' && s.front() != 'D' && s.front() != 'C' && s.front() != 'S') return print("No");
    // if(s.back() < '2' && s.back() > '9' && s.back() != 'A' && s.back() != 'J' && s.back() != 'T' && s.back() != 'Q' && s.back() != 'K') return print("No");
    if(s.back() >= '2' && s.back() <= '9');
    else if(s.back() != 'A' && s.back() != 'J' && s.back() != 'T' && s.back() != 'Q' && s.back() != 'K') return print("No");
    
    if(st.find(s) != st.end()) return print("No");
    st.emplace(s);
  }
